...
pacman -S xorg-server i3 dmenu rxvt-unicode xorg-xinput xorg-xmodmap xorg-xset xorg-xsetroot feh
...
### user stuff
pacman -S openssh firefox flashplugin git fakeroot xdiskusage xorg-xev acpi cdparanoia ripperx python xscreensaver xorg-xrandr numlockx httpie transmission-cli unzip ack pidgin mlocate gnome-themes-standard nautilus privoxy xorg-xbacklight
ssh-keygen # for git
